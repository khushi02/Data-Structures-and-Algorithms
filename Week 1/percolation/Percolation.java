...
public class Percolation {
    ...
    public void open(int row, int col) {
        ...
        if (row == 1) {
            ...
            //objArr[xyTo1D(row, col)] = 2;
        }
        if (row == n) {
            uf.union(virtBottom, xyTo1D(row, col));
            // objArr[xyTo1D(row, col)] = 2;
        }
        if (objArr[xyTo1D(row - 1, col)] == 1 || objArr[xyTo1D(row - 1, col)] == 2) {
            uf.union(xyTo1D(row, col), xyTo1D(row - 1, col));
            //objArr[xyTo1D(row, col)] = 2;
            //objArr[xyTo1D(row - 1, col)] = 2;
        }
        if (objArr[xyTo1D(row + 1, col)] == 1 || objArr[xyTo1D(row + 1, col)] == 2) {
            uf.union(xyTo1D(row, col), xyTo1D(row + 1, col));
            //objArr[xyTo1D(row, col)] = 2;
        ...
        if (objArr[xyTo1D(row, col - 1)] == 1 || objArr[xyTo1D(row, col - 1)] == 2) {
            uf.union(xyTo1D(row, col), xyTo1D(row, col - 1));
            //objArr[xyTo1D(row, col)] = 2;
            //objArr[xyTo1D(row, col - 1)] = 2;
        }
        if (objArr[xyTo1D(row, col + 1)] == 1 || objArr[xyTo1D(row, col + 1)] == 2) {
            uf.union(xyTo1D(row, col), xyTo1D(row, col + 1));
            //objArr[xyTo1D(row, col)] = 2;
    ...
    public boolean isOpen(int row, int col) {
        ...
        if (objArr[xyTo1D(row, col)] == 1 || objArr[xyTo1D(row, col)] == 2) {
            return true;
        }
        else {
            return false;
